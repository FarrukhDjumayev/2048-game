...
export default function Header({ score, highScore, onRestart }: HeaderProps) {
  return (
    <div className="flex items-center justify-between mb-6">
      <h1 className="text-4xl font-extrabold text-[rgba(50,231,5,0.88)] drop-shadow-[0_0_8px_#00ff7f]">
        2048
      </h1>

      <div className="flex items-center gap-4">
        <div className="bg-[#111]/30 backdrop-blur-2xl text-green-300 border border-green-500 px-4 py-2 rounded-lg shadow-inner text-center">
